...
public class TranscoderDispatchController {
    ...
    public Map<String, Object> index(@Body String s3FileLocation) {
        MediaConvertClient mediaConvertClient = MediaConvertClient.create();
        String id = createMediaJob(mediaConvertClient, s3FileLocation);
        mediaConvertClient.close();
        return Collections.singletonMap("id", id);
    }

    private static String createMediaJob(MediaConvertClient mediaConvertClient, String s3InputFileURI) {
    ...
    private static JobSettings createJobSettings(String s3InputFileURI, OutputGroup... outputGroups) {
    ...
    private static OutputGroup createMp4OutputGroup(String mp4Destination) {
